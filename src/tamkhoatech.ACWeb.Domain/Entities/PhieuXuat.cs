...
{
    public class PhieuXuat : FullAuditedEntity<int?>
    {
        ...
        public List<PhieuXuatCt>? PhieuXuatCts { set; get; }
        public List<HoaDonBanHang>? HoaDonBanHangs { set; get; }
        public List<HoaDonGtgt>? HoaDonGtgts { set; get; }
