...
{
    public class PhieuNhapDto : EntityDto<int?>
    {
        ...
        public List<PhieuNhapCtDto>? PhieuNhapCtDtos { set; get; }
        public List<HoaDonGtgtDto>? HoaDonGtgtDtos { set; get; }
        public List<PhanBoChietKhauThuongMaiDto>? PhanBoChietKhauThuongMaiDtos { set; get; }
        public List<PhanBoChiPhiDto>? PhanBoChiPhiDtos { set; get; }
        public List<PhanBoThueNkDto>? PhanBoThueNkDtos { set; get; }
        public List<HoaDonMuaHangDto>? HoaDonMuaHangDtos { set; get; }
    }
}
