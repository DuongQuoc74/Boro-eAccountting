...
{
    public class PhieuXuatDto : EntityDto<int?>
    {
        ...
        public List<SoCaiDto>? SoCaiDtos { set; get; }
        public List<HoaDonGtgtDto>? HoaDonGtgtDtos { set; get; }
        public List<HoaDonBanHangDto>? HoaDonBanHangDtos { set; get; }
        public List<PhieuXuatCtDto>? PhieuXuatCtDtos { set; get; }
    }
}
